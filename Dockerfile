# Pull base image.
FROM jlesage/baseimage-gui:ubuntu-24.04-v4.11


# Install packages
RUN add-pkg apt-utils nano libatk1.0-0 libatk-bridge2.0-0 libgtk-3-0 libgbm-dev libxss1 libasound2t64 wget xterm libnss3 locales xdotool xclip ca-certificates && \
