# Pull base image.
FROM jlesage/baseimage-gui:ubuntu-22.04-v4.10.0
...
RUN \
    ...
    set-cont-env APP_VERSION "3.10.0" && \
    set-cont-env APP_SHA256SUM "2e1d5b555ee1a755ef428793a3190eb53e5376aedac940f347a0ff5600d22164" && \
